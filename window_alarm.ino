...
void send(int value1, int value2, int value3) {
  ...
  if (!client.connect(server, 80)) {
    ...
    url += "?value1=" + (String)"10" + "&value2=" + (String)"12" + "&value3=" + (String)"2";
...
// which has additional links.
    ...
    // well!
      ...
      if (sendResult && (1000*IMU.ax > 10 || 1000*IMU.ay > 10))
      {
        M5.Lcd.print("connect Wifi..");
        M5.Speaker.beep();
        send((int)1000*IMU.ax, (int)1000*IMU.ay, (int)1000*IMU.az);
        sleep(5);
        M5.Speaker.mute();
        sleep(5);
      }
